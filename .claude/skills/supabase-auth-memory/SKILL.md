...
// Session Management - listen for auth state changes
...
For detailed implementation patterns (OAuth, advanced session handling, multi-tenant patterns), see `references/detailed-guide.md`.
